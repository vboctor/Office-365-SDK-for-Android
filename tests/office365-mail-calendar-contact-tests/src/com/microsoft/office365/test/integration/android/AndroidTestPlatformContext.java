...
public class AndroidTestPlatformContext implements TestPlatformContext {
	...
	public String getServerUrl() {
		return PreferenceManager.getDefaultSharedPreferences(mActivity)
				.getString(Constants.PREFERENCE_SHAREPOINT_URL, "");
	}

	@Override
	public String getClientId() {
		return PreferenceManager.getDefaultSharedPreferences(mActivity)
				.getString(Constants.PREFERENCE_AAD_CLIENT_ID, "");
	}

	@Override
	public String getRedirectUrl() {
		return PreferenceManager.getDefaultSharedPreferences(mActivity)
				.getString(Constants.PREFERENCE_AAD_Redirect_URL, "");
	}

	@Override
	public String getAuthenticationMethod() {
		return PreferenceManager.getDefaultSharedPreferences(mActivity)
				.getString(Constants.PREFERENCE_AUTHENTICATION_METHOD, "");
	}

	@Override
	public String getTestListName() {
		return PreferenceManager.getDefaultSharedPreferences(mActivity)
				.getString(Constants.PREFERENCE_LIST_NAME, "");
	}

	@Override
	public String getSiteRelativeUrl() {
		return PreferenceManager.getDefaultSharedPreferences(mActivity)
				.getString(Constants.PREFERENCE_SITE_URL, "");
	}
	...
	public AuthenticationContext getAuthenticationContext() {
		...
		try {
			context = new AuthenticationContext(mActivity,
	...
	public MailClient getMailClient() {
		final SettableFuture<MailClient> future = SettableFuture.create();

		try {
			// here we get the token using ADAL Library
			getAuthenticationContext().acquireToken(mActivity, getServerUrl(),
					...
					new AuthenticationCallback<AuthenticationResult>() {
						...
						public void onSuccess(AuthenticationResult result) {
							...
							MailClient client = new MailClient(credentials);
							future.set(client);
						}
					});
	...
	public ContactClient getContactClient() {
		final SettableFuture<ContactClient> future = SettableFuture.create();
