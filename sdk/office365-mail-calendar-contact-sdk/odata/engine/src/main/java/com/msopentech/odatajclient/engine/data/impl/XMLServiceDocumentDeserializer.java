...
public class XMLServiceDocumentDeserializer extends ODataJacksonDeserializer<ServiceDocumentResource> {
    ...
    @Override
    protected ServiceDocumentResource doDeserialize(final JsonParser jp, final DeserializationContext ctxt)
        ...
        final AbstractServiceDocument sdoc = ODataVersion.V3 == client.getWorkingVersion()
                ...
                : new com.msopentech.odatajclient.engine.data.xml.XMLServiceDocument();
            ...
            if (token == JsonToken.FIELD_NAME) {
                if ("base".equals(jp.getCurrentName())) {
                    if (sdoc instanceof com.msopentech.odatajclient.engine.data.impl.v3.XMLServiceDocument) {
                        ...
                        ((com.msopentech.odatajclient.engine.data.xml.XMLServiceDocument) sdoc).
                                setBaseURI(URI.create(jp.nextTextValue()));
                    }
